      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300">
              Tu tienda de tecnología de confianza. Productos de calidad con la
              mejor atención al cliente.
            </p>
            <div className="flex space-x-4">
              <Link
                href="https://www.facebook.com/dibuy.ar/"
                className="hover:text-magenta transition-colors p-2 bg-gray-800 rounded-full hover:bg-magenta/20"
                target="_blank"
              >
                <Facebook className="h-5 w-5" />
              </Link>
              <Link
                href="https://www.instagram.com/dibuy.ar/"
                className="hover:text-magenta transition-colors p-2 bg-gray-800 rounded-full hover:bg-magenta/20"
                target="_blank"
              >
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-blanco">
              Enlaces rápidos
            </h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/productos"
                  className="text-gray-300 hover:text-magenta transition-colors flex items-center space-x-2"
                >
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  ...
                  className="text-gray-300 hover:text-zafiro transition-colors flex items-center space-x-2"
                >
          ...
          <div>
            ...
            <div className="space-y-3">
              <div
                ...
                onClick={() =>
                  navigator.clipboard.writeText("+54 9 11 5470-7982")
                }
              >
                <div className="p-2 bg-magenta/20 rounded-full">
                  <Phone className="h-4 w-4 text-magenta" />
                </div>
                <span className="text-gray-300 hover:text-magenta transition-colors">
                  +54 9 11 5470-7982
                </span>
              </div>
              <div
              ...
              >
                ...
                <span className="text-gray-300 hover:text-zafiro transition-colors">
                  administracion@comex-consultores.com.ar
                </span>
              </div>
        ...
        <div className="border-t border-gray-700 gap-4 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2026 DIBUY. Todos los derechos reservados.
          </p>
          <div className="flex items-center">
            <a
              href="http://qr.afip.gob.ar/?qr=Z_K3-UrHdyNpbWmJYrohJw,,"
