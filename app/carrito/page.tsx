...
export default function CartPage() {
  ...
  const pickupLocations = [
    {
      id: "sucursal-centro",
      name: "Sucursal Principal - Belgrano CABA",
      address: "Avenida Libertador 5990, oficina 505",
    },
    // {
    //   id: "sucursal-norte",
    //   name: "Sucursal Norte - Av. Alem 456",
    //   address: "Av. Alem 456, Zona Norte",
    // },
    // {
    //   id: "sucursal-sur",
    //   name: "Sucursal Sur - Ruta 9 Km 5",
    //   address: "Ruta 9 Km 5, Zona Sur",
    // },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-lg opacity-90">
              {state.itemCount} productos en tu carrito
            </p>
          </div>
        </div>
      </section>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        <div className="flex items-center justify-center sm:justify-end gap-2">
                          <div className="flex items-center border border-gray-300 rounded-lg">
                            ...
                            <span className="px-2 sm:px-3 py-1 min-w-[30px] sm:min-w-[40px] text-center text-xs sm:text-sm">
                              {item.quantity}
                            </span>
                            <button
                              onClick={() =>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-3">
                            ...
                            {quotes.length > 0 && (
                              <div className="mt-4">
                                ...
                                <select
                                  ...
                                  onChange={(e) =>
                                    handleShippingQuoteChange(e.target.value)
                                  }
                                  className="w-full px-3 py-2 border border-negro bg-blanco-light rounded-lg focus:outline-none focus:border-primary"
                                >
                                  {quotes.map((q) => (
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    {deliveryMethod === "pickup"
                      ? "Gratis (Retiro en sucursal)"
                      : state.shipping
                        ? formatPrice(state.shipping.price)
                        : "-"}
                  </span>
                </div>
